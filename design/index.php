...
<head>
    ...
    <link rel="shortcut icon" href="img/programmer2.png">
...
<body>
    <div id="top_div_title">
        ...
        <p id="top_div_title_p"><strong>CODEMANAGER</strong></p>-->
        <a href="index.html"><img src="img/essai_logo.png" alt=""></a>
        <div id="button_div">
    ...
    <!--<video id="videointro" src="img/Codes.mp4" loop autoplay></video>-->
    <div id="div_img_accueil">
        <!--<img id="img_accueil" src="img/codebcc.jpg">-->
    </div>

    <div id="infos_generales_site">
        <div class="flex_horizon">
            <img class="img_index_desc" src="img/shareindex.png">
            ...
            <br><br><br>
            <img class="img_index_desc" src="img/objectiveindex.png">
        ...
        <div id="espace_div_bcc">
            <div>
                ...
                <button id="button_espace">
                    <p>ACCÉDER À MON ESPACE</p>
                </button>
            </div>
            <img src="img/spring-swing-rocket.png">
        </div>
    </div>
